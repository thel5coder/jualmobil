                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="cs-user-account-holder">
                            <div class="row">
                                    ...
                                    <ul class="cs-featurelisted-car">
                                        @foreach($berita as $dataBerita)
                                            <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="cs-text">
                                                    <h6>
                                                        <a href="{{route('readBerita',['slug' => $dataBerita->slug])}}">{{$dataBerita->judul}}</a>
                                                    </h6>
                                                    ...
                                                    <div class="cs-post-types">
                                                        <div class="cs-post-list">
                                                            ...
                                                            <div class="cs-list">
                                                                <a href="{{route('berita.edit',['slug' => $dataBerita->slug])}}" data-toggle="tooltip" data-placement="top"
                                ...
                                @else
                                    <ul class="cs-featurelisted-car">
                                        <strong>Anda Tidak Punya Berita <a href="{{route('formBerita')}}">Buat
                                                Berita?</a></strong>
                                    </ul>
                                @endif
                            </div>
