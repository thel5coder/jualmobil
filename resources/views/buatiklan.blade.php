                            ...
                            <div class="row">
                                ...
                                <form class="user-post-vehicles">
                                    ...
                                    <div class="cs-field-holder">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="cs-upload-img">
                                                <ul>
                                                    <li><a href="#"><img src="public/extra-images/upload-img-1.jpg" alt="" /></a></li>
                                                    <li><a href="#"><img src="public/extra-images/upload-img-2.jpg" alt="" /></a></li>
                                                    <li><a href="#"><img src="public/extra-images/upload-img-3.jpg" alt="" /></a></li>
                                                </ul>
                                    ...
                                    <div class="cs-field-holder">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <div class="cs-field">
                                                <select data-placeholder="Pilih Merk" tabindex="1" class="chosen-select" name="merk">
                                    ...
                                    <div class="cs-field-holder">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <div class="cs-field">
                                                <select data-placeholder="Pilih Kota" tabindex="1" class="chosen-select" name="kota">
                                                    <option value="United States">United States</option>
                                                    <option value="United Kingdom">United Kingdom</option>
                                                    <option value="Afghanistan">Afghanistan</option>
                                                </select>
