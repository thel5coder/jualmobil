                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent">
                                                                ...
                                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                                    Iklan anda sudah melalui proses moderasi oleh admin, namun sayang sekali iklan anda di tolak oleh admin karena tidak sesuai , dengan alasan {{$data['alasan']}}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
                                                        <tr>
                                                            <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                                <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;"  target="_blank" href="{{route('editIklan',['id' => $data['id']])}}">Perbaiki Iklan</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
