                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent">
                                                                ...
                                                                <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">Selamat {{$data['nama']}}</h2>
                                                                </div>
                                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                                    Selamat iklan anda sudah masuk dalam sistem kami. namun masih dalam tahap moderasi oleh admin. klik link di bawah ini untuk melihat iklan anda.
                                                                    </div>
                                                            </td>
                                                        </tr>
                                                    </table>
